...
import { edrWipAlerts } from 'src/app/pages/landing-page/_model/data.model';

@Component({
  selector: 'app-edr-wip',
  templateUrl: './edr-wip.component.html',
  styleUrls: ['./edr-wip.component.css'],
})
export class EdrWipComponent {
  VTURL = 'https://www.virustotal.com/gui/file';
  expandSet = new Set<string>();
  wipAlerts = edrWipAlerts;
