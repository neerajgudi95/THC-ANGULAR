...
import { edrMainAlerts } from 'src/app/pages/landing-page/_model/data.model';

@Component({
  selector: 'app-edr-main',
  templateUrl: './edr-main.component.html',
  styleUrls: ['./edr-main.component.css'],
})
export class EdrMainComponent {
  VTURL = 'https://www.virustotal.com/gui/file';
  expandSet = new Set<string>();
  mainAlerts = edrMainAlerts;
